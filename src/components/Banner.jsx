...
const Banner = () => {
  return (
    <header className="w-full h-full bg-hero bg-no-repeat bg-cover bg-center bg-fixed flex flex-col justify-between  text-white scroll-smooth">
      ...
      <div className="w-2/6 h-48 flex justify-center items-center">
        <div className="felx justify-center items-center p-5 space-y-12">
          ...
          <a href="#search">
            <button className="bg-transparent border-2 border-white mt-5 p-2 hover:bg-white hover:text-black w-32 h-12">
              Search
            </button>
          </a>
        </div>
